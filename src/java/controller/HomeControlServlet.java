...
public class HomeControlServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int viewed = new ViewDAO().getView();
        request.setAttribute("viewed", viewed);
        //other
        int count = new ProductDAO().countAllProducts();
        request.setAttribute("count", count);
        List<Product> newestList = new ProductDAO().getNewestProduct();
        request.setAttribute("newestList", newestList);
        List<Product> hotList = new ProductDAO().getHotSalesProducts();
