...
public class FeedbackServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        List<Integer> accountIDs = new OrderDAO().getAllAccountIDsOrdered();
        ...
        if (ok == 1) {
            ...
            Feedback feed = new Feedback(msg, "", accountID, 0);

            new FeedbackDAO().addNewFeedback(feed);
            response.sendRedirect("thankFeedback.jsp");
        }
        else{
            response.sendRedirect("errorFeedback.jsp");
        }
