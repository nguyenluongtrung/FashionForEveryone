...
public class ProductDetailsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int quantity_raw = new ProductDAO().getQuantityByID(productID);
        request.setAttribute("quantity_raw", quantity_raw);
        int categoryID = product.getCategoryID();
        List<Product> relatedList = new ProductDAO().getRelatedProduct(productID,categoryID);
