<%-- 
    ...
    Created on : 11 Mar, 2023, 2:59:27 PM
    Author     : ADMIN
--%>
                                        ...
                                        <div class="media-body">
                                            <div class="row">
                                                <div class="col-8 d-flex">
                                                    <c:forEach items="${accounts}" var="a">
                                                        <h5>${a.accountID == c.accountID ? a.fullName : ''}</h5>
                                                    </c:forEach>
                                                </div>
