            ...
            <div class="row justify-content-center">
                <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <form id="msform" style="padding: 3%" action="add-product" method="post">
                            <!-- progressbar -->
                            <ul id="progressbar">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <input type="text" name="purl" placeholder="Image URL"/>
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-7 text-center">
                                            <h5 class="purple-text text-center">You Have Successfully Added Product</h5>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
